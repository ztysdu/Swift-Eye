...
def parse_args():
    ...
    parser.add_argument(
        '--config', help='train config file path', default='mmrotate/train_swift_eye/train_backbone_and_neck/swift_eye_config.py')# The path of the configuration file

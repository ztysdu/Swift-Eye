...
data = dict(
    ...
    train=dict(
        ...
        pipeline=[
            ...
            dict(type='RResize', img_scale=(346, 346)),
            dict(
                type='RRandomFlip',
                flip_ratio=[0.4, 0.1, 0.1],
                direction=['horizontal', 'vertical', 'diagonal'],
                version='le90'),
            dict(type='PolyRandomRotate', angles_range=90),
            dict(
                type='Normalize',
        ...
        version='le90',
        data_root='training_root'), # train dataset
    val=dict(
        type='GazeDataset',
        ann_file='annotations',
        img_prefix='images',
        ...
        version='le90',
        data_root='validation_root'),   # validation dataset
    test=dict(
        type='GazeDataset',
        ann_file='annotations',
        img_prefix='images',
...
model = dict(
    ...
    test_cfg=dict(
        ...
        rcnn=dict(
            ...
            max_per_img=2000)))
work_dir = 'mmrotate/train_swift_eye/train_backbone_and_neck/work_dir'# save model and arg
device = 'cuda'
auto_resume = False
gpu_ids = range(0, 1)

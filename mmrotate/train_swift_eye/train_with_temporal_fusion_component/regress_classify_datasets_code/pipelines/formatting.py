...
class Collect:
    ...
    def __init__(self,
                 ...
                 meta_keys=('filename', 'ori_filename', 'ori_shape',
                            'img_shape', 'pad_shape', 'scale_factor', 'flip','flip_direction',
                             'img_norm_cfg','rotate','rotate_angle')):
        self.keys = keys
    ...
    def __call__(self, results):
        ...
        for key in self.meta_keys:
            if "flip" in key and "flip" not in results.keys(): #train_mode
                img_meta[key] = None
                continue
            if 'rotate' in key and 'rotate' not in results.keys():
                img_meta['rotate'] = False
                img_meta['rotate_angle'] = 0
                continue
